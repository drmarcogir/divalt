...
```r
#' Calculate's Whittaker's species turnover
...
## Mid-domain effect
The function `midalt()` provides a test of the mid-domain effect hypothesis (Colwell & Lees 2000), following the methods of Rahbek et al. (2007).
...
The function `decalt()`  quantifies the increase of dissimilarity in species assemblages and elevational distance. This is equivalent to the distance decay of similarity (Nekola & White 1999). Dissimilarity is calculated using Carvalho et al. (2012) methods and is partitioned into richness and replacement components.
