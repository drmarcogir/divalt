...
``` 
# Example usage
What follows are some simple examples of how this package can be used to analyse elevational diversity patterns. All the examples below were calculated
using data derived from a public dataset from 
