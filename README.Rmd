...
#'@indat=name of dataframe containing species incidence data 
#'@alt=character vector indicating column name for altitude values
#'@group=group =character vector indicating column name for elevational gradient IDs (if there #' is more than one stuy area)
...
mderes<-mdealt(indat=indat,alt="Elevation",group="site")
