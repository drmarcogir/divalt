...
The function `decalt()`  quantifies the increase of dissimilarity in species assemblages and elevational distance. Dissimilarity is calculated using Carvalho et al. (2012) methods and is partitioned into richness and replacement components.
