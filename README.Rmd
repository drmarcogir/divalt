...
The function `decalt()` calculates the distance decay relationship "between altidude and beta diversity components". Dissimilarity
is decomposed into richness and replacement components following the methods of  
